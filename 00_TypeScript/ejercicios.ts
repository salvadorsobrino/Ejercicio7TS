...
*/  
    ...
    let segundaCalificacion : number = 9;
    let terceraCalificacion : number = 8.7;
    let media : number = (primeraCalificacion+segundaCalificacion+terceraCalificacion)/3;
    let examenFinal = 8.5; //Inferencia de tipos
    let trabajoFinal : number = 10;
    let calificacionFinal : number = (media*0.55)+(examenFinal*0.30)+(trabajoFinal*0.15);
...
*/
    ...
    let videojuegos : String[] = ["Mario Kart","Super Mario Bros","Elder Ring","League Of Legends", "Spider-man", "Mario Party" ,"Batman"];
    const palabra = 'Mario';
